...
\documentclass[envcountsame,envcountchap, deutsch, ngerman]{i-studis}
...
\hyphenation{Ele-men-tar-ob-jek-te  ab-ge-tas-tet Aus-wer-tung House-holder-Matrix Le-ast-Squa-res-Al-go-ri-th-men} 		% Weitere Silbentrennung bei Bedarfangeben
...
\begin{document}
%------------------------- Titelblatt -------------------------------------
\title{Übersetzung in einfache Sprache mit Hilfe von Transformern}
\subtitle{Translation into simple language with the help of transformers}
...
\submitdate{25.05.2022} 				% Abgabedatum
%\begingroup
...
\inputencoding{utf8}
\include{chapters/Word2Vec}
\input{chapters/Glove}
\input{chapters/Transformer}
\input{chapters/Bert}
\input{chapters/NMT_Model}
...
%--------------------------------------------------------------------------
\begin{appendix}
	%\include{chapters/Visualization}						% Anh�nge sind i.d.R. optional
